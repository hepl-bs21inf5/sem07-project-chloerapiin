...
const score = computed<number>(() => correctAnswers.value.filter((value) => value).length) /*computed score qui calcule le score en fonction des valeurs de correctAnswers */
const totalScore = computed<number>(() => correctAnswers.value.length) /*calcule le score maximal possible, en prenant le tableau seulement des valeurs correctes */
